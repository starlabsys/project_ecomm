                        ...
                        <div class="single-gallery">
                            <figure class="gallery-img">
                                <a href="assets/img/agency-img27.jpg" data-fancybox="gallery">
                                    <img src="assets/img/agency-img27.jpg" alt="">
                                </a>
                                <div class="facility-wrapper">
                                    <div class="facility-content">
                                        <h4 class="facility-title">
                                            <a href="{{url('buku-monograf')}}">Buku Monograf</a>
                                        </h4>
                                        <p class="facility-info">
                                            Buku monograf, tulisan mendalam ahli tentang satu topik, menjadi sumber penting bagi peneliti dan akademisi. Dengan analisis kritis dan bukti yang teliti, buku ini memperkaya pemahaman tentang suatu tema.
                                        </p>
                                    </div>
                                </div>
                            </figure>
