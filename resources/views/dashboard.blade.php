                    ...
                    <div class="widget-content">
                        <div class="account-box">
                            ...
                            <div class="info-box">
                                <div class="icon">
                                    <span>
                                        <img src="{{ asset('') }}back_assets/src/assets/img/coin.png" alt="money-bag">
                                    </span>
                                </div>
                                ...
                                <div class="item-timeline timeline-new">
                                    ...
                                    <div class="t-content">
                                        <div class="t-uppercontent">
                                            <h5>New project created : <a href="javscript:void(0);"><span>[Dashboard]</span></a></h5>
                                        </div>
                                        <p>07 May, 2022</p>
                                    </div>
                                </div>
                        ...
                        <div class="meta-info">
                            ...
                            <div class="avatar--group">
                                ...
                                <div class="avatar translateY-axis">
                                    <img alt="avatar" src="{{ asset('') }}back_assets/src/assets/img/profile-8.jpg"/>
                                </div>
                                <div class="avatar translateY-axis">
                                    <img alt="avatar" src="{{ asset('') }}back_assets/src/assets/img/profile-12.jpg"/>
                                </div>
                                <div class="avatar translateY-axis">
                                    <img alt="avatar" src="{{ asset('') }}back_assets/src/assets/img/profile-19.jpg"/>
                                </div>
            ...
            <div class="col-xl-4 col-lg-6 col-md-6 col-sm-12 col-12 layout-spacing">
                <div class="widget widget-card-one">
                    <div class="widget-content">
                        ...
                        <div class="media">
                            <div class="w-img">
                                <img src="{{ asset('') }}back_assets/src/assets/img/profile-19.jpg" alt="avatar">
                            </div>
                            <div class="media-body">
                                <h6>Jimmy Turner</h6>
            ...
            <div class="col-xl-4 col-lg-6 col-md-6 col-sm-12 col-12 layout-spacing">
                <div class="widget widget-card-two">
                    <div class="widget-content">
                        ...
                        <div class="media">
                            <div class="w-img">
                                <img src="{{ asset('') }}back_assets/src/assets/img/g-8.png" alt="avatar">
                            </div>
                            <div class="media-body">
                        ...
                        <div class="card-bottom-section">
                            ...
                            <div class="img-group">
                                <img src="{{ asset('') }}back_assets/src/assets/img/profile-19.jpg" alt="avatar">
                                <img src="{{ asset('') }}back_assets/src/assets/img/profile-6.jpg" alt="avatar">
                                <img src="{{ asset('') }}back_assets/src/assets/img/profile-8.jpg" alt="avatar">
                                <img src="{{ asset('') }}back_assets/src/assets/img/profile-3.jpg" alt="avatar">
                            </div>
